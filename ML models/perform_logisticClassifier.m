% This script is used to train a logistic regression classifier via a ten-fold cross
...
LG_mean_perf = {'AUC','accuracy','PPV','NPV','SR','RR';mean_perf(1),mean_perf(2),mean_perf(3),mean_perf(4),mean_perf(5),mean_perf(6)}
LG_std_perf = {'AUC','accuracy','PPV','NPV','SR','RR';std_perf(1),std_perf(2),std_perf(3),std_perf(4),std_perf(5),std_perf(6)}
